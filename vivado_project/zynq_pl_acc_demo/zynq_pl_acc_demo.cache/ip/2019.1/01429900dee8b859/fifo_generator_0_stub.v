...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, srst, din, wr_en, rd_en, dout, full, empty, 
  almost_empty, valid, data_count)
/* synthesis syn_black_box black_box_pad_pin="clk,srst,din[31:0],wr_en,rd_en,dout[31:0],full,empty,almost_empty,valid,data_count[8:0]" */;
  input clk;
  input srst;
  input [31:0]din;
  input wr_en;
