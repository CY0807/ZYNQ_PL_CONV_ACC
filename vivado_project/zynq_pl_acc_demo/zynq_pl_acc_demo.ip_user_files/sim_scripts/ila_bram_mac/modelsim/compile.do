...
vlog -work xilinx_vip -64 -incr -sv -L axi_vip_v1_1_5 -L processing_system7_vip_v1_0_7 -L smartconnect_v1_0 -L xilinx_vip "+incdir+D:/SoftwareRoot/Vivado2019.1/Vivado/2019.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr -sv -L axi_vip_v1_1_5 -L processing_system7_vip_v1_0_7 -L smartconnect_v1_0 -L xilinx_vip "+incdir+../../../../zynq_pl_acc_demo.srcs/sources_1/ip/ila_bram_mac/hdl/verilog" "+incdir+D:/SoftwareRoot/Vivado2019.1/Vivado/2019.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr "+incdir+../../../../zynq_pl_acc_demo.srcs/sources_1/ip/ila_bram_mac/hdl/verilog" "+incdir+D:/SoftwareRoot/Vivado2019.1/Vivado/2019.1/data/xilinx_vip/include" \
