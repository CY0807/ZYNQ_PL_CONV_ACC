...
#
# Generated by Vivado on Thu Apr 13 14:26:08 +0800 2023
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/SoftwareRoot/Vivado2019.1/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/SoftwareRoot/Vivado2019.1/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/SoftwareRoot/Vivado2019.1/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../zynq_pl_acc_demo.srcs/sources_1/ip/pll/pll_clk_wiz.v" \
    "$ref_dir/../../../../zynq_pl_acc_demo.srcs/sources_1/ip/pll/pll.v" \
  2>&1 | tee -a vlogan.log
