...
simulate()
{
  xsim pll -key {Behavioral:sim_1:Functional:pll} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_44e3.protoinst" -protoinst "protoinst_files/bd_d5b8.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
