...
/* Definitions for driver PL_REG0 */
#define XPAR_PL_REG0_NUM_INSTANCES 1

/* Definitions for peripheral PL_REG0 */
#define XPAR_PL_REG0_DEVICE_ID 0
#define XPAR_PL_REG0_S00_AXI_BASEADDR 0x43C00000
#define XPAR_PL_REG0_S00_AXI_HIGHADDR 0x43C0FFFF
