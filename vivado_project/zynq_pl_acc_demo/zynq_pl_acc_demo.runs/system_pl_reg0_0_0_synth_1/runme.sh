...
HD_PWD='D:/github_repo/ZYNQ_PL_CONV/vivado_project/zynq_pl_acc_demo/zynq_pl_acc_demo.runs/system_pl_reg0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pl_reg0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pl_reg0_0_0.tcl
