...
HD_PWD='D:/github_repo/ZYNQ_PL_CONV/vivado_project/zynq_pl_acc_demo/zynq_pl_acc_demo.runs/fifo_acc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_acc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_acc.tcl
