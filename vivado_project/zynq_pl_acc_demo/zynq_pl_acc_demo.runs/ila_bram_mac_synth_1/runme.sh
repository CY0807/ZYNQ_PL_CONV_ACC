...
HD_PWD='D:/github_repo/ZYNQ_PL_CONV/vivado_project/zynq_pl_acc_demo/zynq_pl_acc_demo.runs/ila_bram_mac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_bram_mac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_bram_mac.tcl
