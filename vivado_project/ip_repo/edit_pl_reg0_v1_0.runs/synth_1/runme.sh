...
HD_PWD='d:/github_repo/zynq_pl_conv/vivado_project/ip_repo/edit_pl_reg0_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_reg0_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_reg0_v1_0.tcl
